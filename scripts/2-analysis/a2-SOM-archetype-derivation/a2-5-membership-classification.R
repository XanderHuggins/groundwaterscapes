...
# write_rds(membership_dict, file = here("data/DICT_training_prototype_archetype.rds"))
...
# create raster of prototypes within each archetype
for (i in 1:10) {
  # i = 6
...
# create raster of extent of each archetype
for (i in 1:10) {
