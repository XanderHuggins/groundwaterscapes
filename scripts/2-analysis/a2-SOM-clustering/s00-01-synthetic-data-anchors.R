...
synthetic_anchors$betweenss/synthetic_anchors$totss # >98% so satisfied with representation 
n.sample/nrow(data_all) # A sample of 2% of the dataset represents ~98% of the data variance
