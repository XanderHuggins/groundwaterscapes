...
n_patterns = input_data |> nrow() #10,000
...
write_rds(iter_index, file = here("data/som_files/som_derivation_data/01_synthetic_SOM_iteration_sizing_index.rds"))

iter_index = read_rds(here("data/som_files/som_derivation_data/00_synthetic_SOM_iteration_sizing_index.rds"))