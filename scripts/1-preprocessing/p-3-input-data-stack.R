### ---------------------\\ 
# Script objective:
# Create raster stack of input data, normalize layers, and export in spatial and tabular formats  
### ---------------------\\
...
# Create raster stack of all inputs and mask to land area
data_stack = c(
...
# Mask Greenland as limited data availability
...
# Import raster stack (can re-run from here if above is already completed)
...
# Create constant mask for project -- combining land mask and grid cells with complete data coverage 
...
# Normalize data layers that aren't already normalized
# wtr
...
# see maps
plot(data_stack); summary(data_stack)
